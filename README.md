...
Imported clean data into a relational database to write complex queries—segmenting users by purchasing habits, tracking revenue contribution by age demographics, and calculating discount conversion rates.
